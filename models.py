...
class PCNet1(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        if self.dprate == 0.0:
            ...
            x = F.dropout(x, p=self.dropout3, training=self.training)
            x = self.prop1(x, edge_index)
